            ...
            <div className="contact__content">
                ...
                <div className="contact__form-section">
                    ...
                    <p className="contact__subtitle">
                        Chętnie pomożemy bezpiecznie załatwić Twoją sprawę - zostaw kontakt.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="contact__form">
                        ...
                        <div className="contact__consent">
                            ...
                            <label htmlFor="privacy">
                                Wyrażam zgodę na przetwarzanie moich danych osobowych zawartych w formularzu zgodnie z Polityką Prywatności
                            </label>
                        </div>
                        <Button
                            type="submit"
